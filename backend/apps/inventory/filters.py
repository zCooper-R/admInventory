...
class DeviceFilter(django_filters.FilterSet):
    ...
    replacement_status = django_filters.ChoiceFilter(choices=Device.replacement_status.field.choices)
    ...
    use_for_presentations = django_filters.BooleanFilter(field_name="use_for_presentations")
